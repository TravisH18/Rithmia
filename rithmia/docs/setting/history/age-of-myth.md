...
This is the base era for most of the standard D&D games in this setting will be run 
...
Transition Catalyst: With the defeat of Tiamat and the birth of three new demigods the masses begin to learn to rebuild instead of  

### 200PD - 700PD 
Medieval age / growth of city-states 

First large city states begin to prosper across the various continents 

Growth in religions of all kinds inspired by two facts: Three new demigods have been "born", maybe you could be next to be "chosen" 

Transition Catalyst: Eun'sur grow in influence in rural areas and begin encouraging the harvesting of Elemental Vortices. 

Transition of influence from the end of this age and beginning of next from Druid -> Monk -> Wizard. 

Druid have strong oral traditions, Monks write those traditions down and then Wizards take over monasteries and codify them (or in some cases steal the written works and then teach them to the masses in mage academies). 
...
Power is displayed via Arcane prowess and magical affinity 

Oligarchy of mages and Mageocracy should be a dominant form of government through Rithmia. As well as powerful theocracies where great paladins, clerics, sorcerers of divine blood rule devout nations. 
...
Eco-conscious societies embrace renewable energy while some industrialists manipulate and conspire against this new tech to hold on to what wealth they still have. 

Green communes and decentralized governance replace megacorporation. 

Some cults worship solar power as a deity of it's own. 
...
Create "off-world solar farm " aka a Dyson belt (Dyson swarm surrounding the belt of the sun like Saturn's rings 

Make it so energy is not reliant on any outside force and the human body can be the battery of civilization leading to the next era 
...
Cybernetic enhancements, data networks, neon-lit megacities 

Human-technology merger (can use the x-men merging thing as influence) 
...
This is mostly an extension of the previous age of cyberpunk influence and their are many similarities between the two 

Things like genetic engineering and living machines (A.I.) made of a metal that can "grow" (___) and repair itself become common place. 

Scientists study this to create a bio - aether - machine DNA hybrid that can self repair leading to erasure of things like 'dying of old age' 
...
Magic-powered cybernetics, solar-fueled biotech, and steampunk inspired artistry in gadgets / tech. 
