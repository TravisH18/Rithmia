...
Look up Jotun Giant in Tome of beasts 1 

## Genie’s 
Genie’s had the strongest raw magic ability. They used their innate connection to the weave to create items and other strategies to overcome the physical strength of the giants and dragons. While each genie subset didn’t necessarily have the exact same beliefs they were able to work together to create items that allowed them to achieve amazing things. The most notable was the hamilat aljazira (Island carrier) that is a mythallar. It is essentially a magic generator that constantly enchants a rare metal found in the center of the mountain they cut the peaks off and flip upside down to build cities on. This metal is a cobalt grey naturally however, the djiin and the dao combined their powers into the hamilat aljazira, a magic generator that is a pure silver color and generates a constant wind current that is pure arcane energy that penetrates the stone all around and enchanting the rare metal which lights up a fluorescent royal blue color, when enchanted the mountain can be raised into the sky. Small ones of these can be built in castles by powerful arcane users (new 9th level spell with after effects like wish). This blue color makes these islands sometimes hard to spot against the blue sky backdrop. The nature of the generator is a combination of mostly air and earth magic so it constantly pulls in air and transfers the wind energy to power the ___. This makes floating islands attract clouds as well as it sucks them in. Makes for well hydrated fertile soil as well. In the future the ___ will be scattered and a better aljazira will be made with science and will enable floating ships and small floating civilizations. 
...
**Earth Champion: Grundir Stoneheart** A massive Giant with skin like granite. He can manipulate earth and stone, creating walls, tunnels, and even causing earthquakes. Motivation: To prove that the Giants are the most connected to the earth and deserve to rule over it. 

**Fire Champion: Fahrenor the Forger** A Giant with lava flowing in his veins. He can control fire and heat, forging weapons and armor from molten rock. Motivation: To show that fire is a purifying force and that only the strongest deserve to control it. 

**Air Champion: Skyreach the Windspeaker** A Cloud Giant with feathers instead of hair, able to control the winds and breathe in the thin air of high altitudes. Motivation: To demonstrate that air is the most vital element and that Giants, with their large lungs, are best suited to control it. 

**Water Champion: Tidecaller the Floodbringer A Storm Giant who can manipulate water, causing floods and tides to obey his commands. He has gills and can breathe underwater.  Motivation: To assert that water is the source of life and that Giants, with their connection to rivers and lakes, should govern it. 

### Genies Faction: 

- **Earth Champion: Djinna of the Sands**
    - A powerful Earth Genie who can manipulate sand and soil, creating powerful sandstorms and earth tremors. 
    - Motivation: To prove that Genies are more adaptable and thus better rulers over the elements. 
- Fire Champion: Ifrit Stormheart 
    - A Fire Genie who can control flames and heat, summoning infernos and volcanic eruptions. 
    - Motivation: To show that fire is the most destructive and therefore the most respected element, making Ifrits natural leaders. 
- Air Champion: Djinn Windrunner 
    - An Air Genie who can control the winds, fly at incredible speeds, and even manipulate weather patterns. 
    - Motivation: To demonstrate that air is the most pervasive element, reaching everywhere, making Air Genies the ideal rulers. 
- Water Champion: Marid Tidecaller 
    - A Water Genie who can command the oceans, create tsunamis, and breathe underwater. 
    - Motivation: To assert that water is the most essential element for life and that Water Genies should govern its distribution and use. 

### Dragons Faction: 
- Earth Dragon: Holdrovo the Stoneshaper  
    - An Brown Dragon who can manipulate stone and earth, creating powerful barriers and causing earthquakes. 
    - Motivation: To establish Dragon dominance over all elements, starting with Earth. 
- Fire Dragon: Ieldrog the Flameheart 
    - A Red Dragon with intense heat and the ability to breathe fire, capable of igniting vast areas. 
    - Motivation: To prove that Fire Dragons are the most powerful and thus deserve to rule over all elements. 
- Air Dragon: Aerowind the Skymaster 
    - A Silver Dragon who can control winds and fly at incredible heights, manipulating weather to suit his needs. 
    - Motivation: To assert Air Dragons' superiority due to their ability to traverse any terrain and control the skies. 
- Water Dragon: Fyrmolun the Tidebinder 
    - A Water Dragon who can manipulate water, create storms, and breathe underwater, controlling seas and rivers. 
    - Motivation: To claim that Water Dragons are the most versatile and therefore the most suitable rulers over all elements. 